(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactTab"] = factory();
	else
		root["ReactTab"] = factory();
})(this, function() {
...
var _tabContext = __webpack_require__(8);
...
exports.default = _react2.default.createContext({
    selectedTabIndex: 0,
    onSelectedTabIndexChange: function onSelectedTabIndexChange(tabIndex) {}
});
...
exports.LaTab = exports.LaTabs = undefined;
...
var LaTabs = exports.LaTabs = _Tabs2.default;
var LaTab = exports.LaTab = _Tab2.default;
...
var Tabs = function (_Component) {
    ...
    function Tabs(props) {
        ...
        _this.tabComponents = props.children;
        var selectedTabIndex = 0;
        _this.tabComponents.some(function (tab, index) {
        ...
        _this.onSelectedTabIndexChange = _this.onSelectedTabIndexChange.bind(_this);
        return _this;
    }
    ...
    _createClass(Tabs, [{
        ...
        value: function renderTabHeaderItems() {
            var selectedTabIndex = this.state.selectedTabIndex;


            return this.tabComponents.map(function (item, index) {
                return _react2.default.createElement(_Tab2.default, { key: index,
                    tabIndex: index,
        ...
        key: 'renderSelectedTabContent',
        value: function renderSelectedTabContent() {
            var selectedTabIndex = this.state.selectedTabIndex;
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                { value: _extends({}, this.state, { onSelectedTabIndexChange: this.onSelectedTabIndexChange }) },
                _react2.default.createElement(
                    'div',
                    { className: (0, _utils.mergeClassName)(this.props, 'la-tabs') },
                    _react2.default.createElement(
                        'ul',
                        { className: 'la-tabs-nav' },
                        this.renderTabHeaderItems()
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'la-tabs-selected-tab-content' },
